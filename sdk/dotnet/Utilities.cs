...
namespace squaredup.SquaredUpPackage.Squaredup
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/squaredup/pulumi-squaredup";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("squaredup.SquaredUpPackage.Squaredup.version.txt");
    ...
    internal sealed class SquaredupResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SquaredupResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
