...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] api_key: API Key for SquaredUp API. May also be set via the SQUAREDUP_API_KEY environment variable.
        :param pulumi.Input[str] region: Region of your SquaredUp instance. May also be set via the SQUAREDUP_REGION environment variable.
        """
