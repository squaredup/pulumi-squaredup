module github.com/squaredup/pulumi-squaredup/provider

go 1.21.3

replace github.com/squaredup/terraform-provider-squaredup/shim => ./shim
...
require (
	...
	github.com/squaredup/terraform-provider-squaredup/shim v0.0.0-00010101000000-000000000000
)
...
require (
	...
	github.com/squaredup/terraform-provider-squaredup v1.0.1 // indirect
