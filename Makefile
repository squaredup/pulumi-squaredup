SHELL            := /bin/bash
PROJECT          := github.com/squaredup/pulumi-squaredup
NODE_MODULE_NAME := @squaredup/pulumi-squaredup
TF_NAME          := squaredup
...
TFGEN            := pulumi-tfgen-squaredup
PROVIDER         := pulumi-resource-squaredup
